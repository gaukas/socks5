...
func (p *PacketAuthRequest) Write(w io.Writer) error {
...
func (p *PacketAuthSelect) Read(r io.Reader) error {
...
func (p *PacketUserPassAuth) Write(w io.Writer) error {
	return fmt.Errorf("not implemented for client-sent packet")
}
...
func (p *PacketUserPassAuthStatus) Read(r io.Reader) error {
	return fmt.Errorf("not implemented for server-sent packet")
}
...
func (p *PacketRequest) Write(w io.Writer) error {
	return fmt.Errorf("not implemented for client-sent packet")
}
...
func (p *PacketReply) Read(r io.Reader) error {
	return fmt.Errorf("not implemented for server-sent packet")
}
